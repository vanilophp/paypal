...
class PaymentResponseTest extends TestCase
{
    ...
    #[Test] public function native_status_is_a_paypal_order_status()
    {
    ...
    #[Test] public function native_status_is_set_in_the_constructor()
    {
    ...
    #[Test] public function pending_native_status_maps_to_pending_status()
    {
